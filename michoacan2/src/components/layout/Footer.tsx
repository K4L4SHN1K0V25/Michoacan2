      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/artist/register" className="text-gray-400 hover:text-white transition-colors">
                  Become an Artist
                </Link>
              </li>
              <li>
                <Link href="/artist/login" className="text-gray-400 hover:text-white transition-colors">
                  Artist Login
                </Link>
              </li>
              <li>
                <Link href="/artist/help" className="text-gray-400 hover:text-white transition-colors">
                  Help Center
                </Link>
              </li>
              <li>
                <Link href="/artist/guidelines" className="text-gray-400 hover:text-white transition-colors">
                  Guidelines
                </Link>
              </li>
            </ul>
